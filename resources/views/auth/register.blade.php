...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center h4">{{ __('Créer un compte') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Identifiant') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 input-group">
                                ...
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>La confirmation du mot de passe ne correspond pas</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
