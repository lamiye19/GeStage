                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <th>
                      ...
                      <form id="refus-{{$demande->id}}"
                        action="{{ route('demande.update', ['demande'=>$demande->id, 'status'=>'refus']) }}"
                        method="post">
                        @csrf
                      ...
                      <a href="" class="btn btn-info"
                        onclick="document.getElementById('attente-{{$demande->id}}').submit()">
                        Donner un RDV
                      </a>
                      <form id="attente-{{$demande->id}}"
                        action="{{ route('demande.update', ['demande'=>$demande->id, 'status'=>'attente']) }}"
                        method="post">
                        @csrf
                        <input type="hidden" name="_method" value="put">
                      </form>
